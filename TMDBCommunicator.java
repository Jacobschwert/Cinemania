...
public class TMDBCommunicator {
    ...
    public static TMDBMovieResultList getContentSearchMovieResultList(String searchQuery){
        HttpResponse<String> getResponse = getRequestWithURL(String.format("https://api.themoviedb.org/3/search/movie?api_key=c75eadbc8c681679c1367a2c3f62e19a&language=en-US&query=%s&include_adult=false", API_KEY, searchQuery));
        Gson gson = new Gson();
